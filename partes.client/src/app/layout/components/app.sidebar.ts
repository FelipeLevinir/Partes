    ...
    template: ` 
      <div class="layout-sidebar" (mouseenter)="onMouseEnter()" (mouseleave)="onMouseLeave()">
        <div class="sidebar-header">
            <a class="logo">
               @if(!isDarkTheme()){
                  <img class="logo-image" src="assets/layout/images/camaralogo_light.png" alt="logo" />
               }@else {
                  <img class="logo-image" src="assets/layout/images/camaralogo.png" alt="logo" />
               }
                <span class="app-name text-4xl font-medium leading-normal">App Short Name</span></a
            >
