...
export class LayoutService {
    ...
    bodyBackgroundPalette = {
        light: {
            ...
            blue: 'rgb(225 231 245)', //'linear-gradient(180deg, #e0e7f5 0%, rgba(170, 194, 239, 0.06) 111.26%)',
    ...
    constructor() {
        ...
        effect(() => {
            ...
            this.updateBodyBackground(config.primary); // Usa el primary color actual
        });
        ...
        effect(() => {
            const isActive = this.isSidebarActive(); // ← se actualiza automáticamente
            const sidebarWidth = isActive ? '17.5rem' : '1rem';
